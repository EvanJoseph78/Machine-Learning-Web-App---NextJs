...
// Define as propriedades aceitas pelo componente ClassesForm
...
// Define o componente funcional ClassesForm
export const ClassesForm = ({ initialData, courseId }: ClassesFormProps) => {
