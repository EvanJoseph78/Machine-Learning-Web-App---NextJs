...
export const ModuleForm = ({ initialData, courseId }: ModuleFormProps) => {
    ...
    <div className="mt-6 rounded-xl p-4 border shadow-md">
      ...
      {!isEditing && (
        <div className="space-y-2">
          <ModuleItem moduleName={"Machine Learning"}></ModuleItem>
          {/* <ModuleItem moduleName={"Módulo 2"}></ModuleItem> */}
        </div>
      )}
      {isEditing && (
        <Form {...form}>
