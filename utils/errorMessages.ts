export const errorMessages = {
  // user errors
  MISSING_IDS: "User ID and Course ID are required.",
  INVALID_ID_FORMAT: "Invalid User ID or Course ID format.",
  USER_NOT_FOUND: "User not found in database.",
  ALREADY_SUBSCRIBED: "User is already subscribed to this course.",
  SUBSCRIPTION_ERROR:
